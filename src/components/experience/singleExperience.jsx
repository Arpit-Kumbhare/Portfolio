...
const singleExperience = ({company, job, location, startDate, endDate, reponsibilites}) => {
  return (
    <div>
        <div className='sm:text-base md:text-lg text-white/60 lg:h-[350px] sm:h-auto lg:w-auto sm:w-auto border-dashed border-[2px] rounded-lg p-4 flex flex-col justify-start items-start hover:scale-105 transition-all duration-500'>
