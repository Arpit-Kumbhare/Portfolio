...
const allSkills = () => {
  ...
  return (
    <div className=' flex justify-center items-center flex-col'>
        ...
        <div className='sm:hidden lg:flex relative justify-center items-center h-[110px] w-[310px] mt-8 border-none rounded-full bg-gradient-to-r from-lightBrown via-brown to-darkBrown animate-pulse -z-10'>
